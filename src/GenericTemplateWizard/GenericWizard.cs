...
{
    public abstract class GenericWizard<T> : IWizard where T : BaseWizardLogic, new()
    {

        protected T logic;
        protected WizardFrontend frontend;

        public GenericWizard()
        {
            this.logic = new T();
        }
        public GenericWizard(T logic)
        {
            this.logic = logic;
        }
        ...
        {
            frontend = new WizardFrontend(logic);
            frontend.ShowDialog();
